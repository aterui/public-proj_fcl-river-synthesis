...
**Authors**: Terui A, Shibasaki S, Pomeranz JPF, Mason Ibrahim, Ethan Isaac, Ashley LaRoque, Yamazaki D, Finlay JC
...
Coordinate precision was categorized as follows (**4** and **5** have been excluded in `data_fcl_src.rds`):
