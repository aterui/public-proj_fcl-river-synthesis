\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta01_nu01_theta025.pdf}
\caption{Numerical prediction with dispersal decay rate $\delta_0 = 0.1$ (for producers), disturbance decay rate $\nu = 0.1$, and weak omnivory $\theta = 0.25$. Heatmaps of FCL are expressed as a function of ecosystem size (river length, $L$)
...
\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta01_nu01_theta05.pdf}
...
\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta01_nu005_theta025.pdf}
...
\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta01_nu005_theta05.pdf}
...
\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta005_nu01_theta025.pdf}
\caption{Numerical prediction with dispersal decay rate $\delta_0 = 0.05$ (for producers), disturbance decay rate $\nu = 0.1$, and weak omnivory $\theta = 0.25$. Heatmaps of FCL are expressed as a function of ecosystem size (river length, $L$)
and complexity (branching rate, $\lambda_b$), with rows and columns displaying
different combinations of resource supply ($r_0$), disturbance regime
($\mu^{(0)}$), prey effect ($\mu^{(1)}$), and predation effect ($\mu^{(2)}$).
Each cell represents the average FCL of five food webs.
...
\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta005_nu01_theta05.pdf}
\caption{Numerical prediction with dispersal decay rate $\delta_0 = 0.05$ (for producers), disturbance decay rate $\nu = 0.1$, and strong omnivory $\theta = 0.5$.Heatmaps of FCL are expressed as a function of ecosystem size (river length, $L$)
and complexity (branching rate, $\lambda_b$), with rows and columns displaying
different combinations of resource supply ($r_0$), disturbance regime
($\mu^{(0)}$), prey effect ($\mu^{(1)}$), and predation effect ($\mu^{(2)}$).
...
\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta005_nu005_theta025.pdf}
\caption{Numerical prediction with dispersal decay rate $\delta_0 = 0.05$ (for producers), disturbance decay rate $\nu = 0.05$, and weak omnivory $\theta = 0.25$. Heatmaps of FCL are expressed as a function of ecosystem size (river length, $L$)
and complexity (branching rate, $\lambda_b$), with rows and columns displaying
different combinations of resource supply ($r_0$), disturbance regime
($\mu^{(0)}$), prey effect ($\mu^{(1)}$), and predation effect ($\mu^{(2)}$).
...
\begin{figure}
\centering
\includegraphics[keepaspectratio]{tex/fig_theo_delta005_nu005_theta05.pdf}
\caption{Numerical prediction with dispersal decay rate $\delta_0 = 0.05$ (for producers), disturbance decay rate $\nu = 0.05$, and strong omnivory $\theta = 0.5$.Heatmaps of FCL are expressed as a function of ecosystem size (river length, $L$)
and complexity (branching rate, $\lambda_b$), with rows and columns displaying
different combinations of resource supply ($r_0$), disturbance regime
($\mu^{(0)}$), prey effect ($\mu^{(1)}$), and predation effect ($\mu^{(2)}$).
