...
$r_0$ & Resource supply [-] & 0.40, 0.80 \\ 
  ...
  $g_0$ & Number of propagules for producers [-] & 5 \\ 
  $\delta_0$ & Dispersal capability for producers [unit river length] & 0.05, 0.10 \\ 
  ...
  $\nu$ & Spatial scale of disturbance synchrony [per unit river length] & 0.05, 0.10 \\ 
