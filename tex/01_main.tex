...
In addition, we statistically controlled the potential confounding effects of human influences by including the human footprint index, an integrated variable that summarizes eight pressure variables such as population density, land transformation, and infrastructures \citep{mu_global_2022}.
