...
Table \ref{tab:parms-est} presents the parameter estimates of the random-intercept model, excluding the regression coefficients, which are detailed in the main text.

\input{rmd/table_si_emp}
