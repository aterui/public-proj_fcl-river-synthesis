...
where $r_0$ ($0 \le r_0 \le 1$) is the (minimum) resource supply, and the parameter $b$ ($\ge 0$) expresses the downstream accumulation of resource as a coefficient of the upstream river length at patch $i$ ($u_i$).
